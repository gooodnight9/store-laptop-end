          ...
          <div class="row">
            ...
            <div class="col-lg-6 col-6">
              ...
              <div class="small-box bg-danger">
                <div class="inner">
                  <h3 id="customercount">65</h3>

                  <script>
                    // Gọi API
                    fetch('http://localhost:8000/api/getcounts')
                      .then(response => {
                        if (!response.ok) {
                      ...
                      .then(data => {
                        ...
                        document.getElementById('customercount').innerText = `${data.customer}`;
                      })
                      .catch(error => {
