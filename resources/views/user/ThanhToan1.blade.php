...
<head>
    ...
    <link rel="stylesheet" href="/css/user/ThanhToan1.css">
    ...
    <div class="container">
        <div class="main-content">
            <div class="tabs">
                ...
                <buttonc class="active2">Nhận hàng tại điểm</buttonc>
            </div>
            <script>
                document.getElementById('button-cart').addEventListener('click', function() {
                    window.location.href = '{{ route("order1.cancel") }}'; // Chuyển hướng đến route xác nhận hủy đơn
                });
            </script>
